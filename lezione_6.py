...
# Serve per creare un blocco di istruzioni a cui assegno un nome e che posso riutilizzare più volte
...
# print(acc) Errore, non è definita al di fuori della funzione (scope locale) 
